...
from financeos.accounting.models import Transaction, Invoice, Account
from financeos.hr.models import Employee
from financeos.procurement.models import PurchaseOrder
...
from financeos.ai_engine.models import AIInsight, AnomalyDetection
